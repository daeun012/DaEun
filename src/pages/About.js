...
const About = () => (
  <div className="about">
    ...
    <div className="body">
      ...
      <p>
        <b>왜?라는 질문을 좋아합니다.</b> 모든 것에는 이유가 있다고 생각합니다. 그 이유를 이해하고 그 근거를 학습하고자 합니다.
      </p>
      <p>직관적이고 매력적인 화면을 구현하는 것에 관심을 갖고 있습니다. 또한 팀원들과의 협업을 중시하며, 항상 요구에 부응하는 최선의 솔루션을 찾고자 합니다.</p>
      <p>
