...
const About = () => (
  <div className="container-about">
    ...
    <div className="body">
      ...
      <h3>왜?로 시작하는 개발자</h3>
      <p>
        <b>항상 왜?라는 의문을 품으며 학습하고 습득한 내용들을 기록합니다.</b> 아는 것 만으로는 충분하지 않다고 생각합니다. 토이 프로젝트를 통해 적용해 나가며
        성장하고 있습니다.
      </p>
      <p>
      ...
      <div className="abilities">
        ...
        <div className="skill">
          <h3>Certificate</h3>
          <div className="img">
            <img src="https://daeun012.github.io/DaEun/images/certificate.jpg" alt="certificate" height="120" width="180" />
          </div>
        </div>
      </div>
    </div>
